...
CHK_SH=${EXE_DIR}/root.vtsapi_ttshow.sh
...
do
    curl -o ${AFT_FILE} -sS -k -X POST -H "Authorization: Bearer ${TOKEN}" -H 'Content-Type: application/json' -d @${TGT_CURL} https://${TGT}/api/tokentemplates/
    RC=$?
done
