...
curl -sS -k -X POST -u ${USER} -H 'Content-Type: application/json' -d @${TGT_CURL} https://${TGT}/dsm/v1/system/configs/datetime
RC_C=$?

curl -sS -o ${AFT_FILE} -k -X GET -u ${USER} https://${TGT}/dsm/v1/system/configs/datetime
RC=$?
